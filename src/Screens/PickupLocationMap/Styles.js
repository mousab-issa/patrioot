...
export default StyleSheet.create({
  ...
  searchStyle: {
    width: Screen.width,
    paddingHorizontal: Constants.ResponsiveSize.f13,
    paddingTop: Constants.ResponsiveSize.f10,
    marginLeft: Constants.ResponsiveSize.f8,
  },
  addressOuter: {
    flexDirection: 'row',
    width: '100%',
  ...
  addressIconOuter: {
    backgroundColor: Colors.PickUpLocation,
