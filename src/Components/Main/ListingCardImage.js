                    ...
                    <View style={styles.outerStyle}>
                        <ShimmerPlaceholder visible={this.props.isLoading} height={windowWidth * 0.60}
                            ...
                            <ImageBackground source={require("./../../../assets/images/grey-image.jpg")}
                                ...
                                imageStyle={{ borderTopLeftRadius: BORDER_RADIUS, borderTopRightRadius: BORDER_RADIUS, borderBottomLeftRadius: BORDER_RADIUS, borderBottomRightRadius: BORDER_RADIUS }}>
